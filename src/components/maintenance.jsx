...
export const MaintenancePage = ()  => {
    return (
        <div className='relative min-h-screen w-full overflow-hidden' style={{ backgroundColor: '#C4A020' }}>
            <div className="absolute inset-0 z-0 h-full w-full">
                <img src="/grid-black.jpg" 
                className='mix-blend-overlay opacity-10 h-full md:w-full object-cover' alt="" />
            </div>
            {/* Center content */}
            <div
            ...
            >
                ...
                <div className="mb-6 flex items-center gap-2">
                    <img src="/logo-white.png" alt="logo" width={200} height={100} style={{ filter: 'brightness(0) invert(1)' }} />
                </div>

                {/* Main heading */}
                <h1 className="mb-4 text-center font-black text-white">
                    <span className="block text-2xl uppercase tracking-tight md:text-5xl lg:text-6xl">Faites-en + avec</span>
                    <span className="block text-2xl uppercase tracking-tight md:text-5xl lg:text-6xl">vos investissements</span>
                </h1>
